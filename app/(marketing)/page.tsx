    ...
    <div className="min-h-screen bg-white -mt-18 md:-mt-24">
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div>
              ...
              <Link
                href="/about"
                className="inline-flex items-center gap-2 mt-10 text-lg font-semibold text-gray-900 hover:text-blue-600 transition-colors"
              >
                더 자세히 알아보기 →
              </Link>
            </div>
      ...
      <section className="py-24 bg-white">
        <div className="container mx-auto px-4">
          {/* 제목 */}
          <div className="mb-20">
            <p className="text-xl text-gray-900 mb-2">우리가</p>
            <p className="text-xl text-gray-900">
              <strong>액티브 시니어 웰니스 라이프</strong>를 그리는
            </p>
            <p className="text-xl">
              <strong className="text-blue-600">3가지 방법</strong>
            </p>
          </div>
      ...
      <section className="py-24 bg-black text-white">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            {/* 텍스트 & 다운로드 버튼 */}
            <div>
              <div className="inline-block px-4 py-1 bg-blue-600 text-white rounded-full text-sm mb-6">
                맨발루 앱 다운로드
              </div>
